...
const PRIVATE_SVC = [
  ...
  { mono: 'WF', port: 8089, name: 'Who Fed?', sub: 'Ranked Flex · League of Legends', bg: '#14203a', fg: '#e2b358' },
  { mono: 'SX', port: 8181, name: 'sotrixOS', sub: 'Sistema personal', bg: '#1a2340', fg: '#8fa8ff' },
